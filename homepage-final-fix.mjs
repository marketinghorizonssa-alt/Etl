...
for (const file of htmlFiles(out)) {
  ...
  // Make the phone row deterministic in RTL: Arabic label on the right,
  // isolated LTR number immediately beside it, without bidi reordering.
  html = html.replace(
    /<a class="contact-line" data-track="call" href="tel:\+966920029967"><b>تحدث إلينا<\/b><span dir="ltr">\+966\s*920029967<\/span><\/a>/g,
    '<a class="contact-line contact-phone-line" data-track="call" href="tel:+966920029967"><b>تحدث إلينا</b><span class="footer-phone-number" dir="ltr"><bdi>+966 920029967</bdi></span></a>'
  );
